...
subdir = 'C:/Users/jflores/Documents/JORGE/TESIS/TESIS_PHD/DEB/ichthyop_DEB/Engraulis_encrasicolus_param/DEBoutV2';
mkdir(subdir);
...
% 		end
        ...
        out_mat = table(t,E,V,E_R,F,t_vec,f_vec,del,...
                        'VariableNames',...
                        {'t','E','V','E_R','Fec','temp','f','delta'});
