...
%% FORCING VARIABLES
T = repmat(18.5 + T_K, n_iter,1); % K, Temperature
...
% del_M1  = 0.06; % -, shape coefficient for standard length of larvae
...
out_mat = table(t,E,V,E_H,E_R,F,acc,del,...
                        'VariableNames',...
                        {'t','E','V','E_H','E_R','F','acc','delta'});
writetable(out_mat, strcat('C:/Users/jflores/Desktop/DEB_out.txt'))
...
fprintf('length at early juvenile stage = %d\n',L_w(i_y))    %cm, length at maturity at the end of the early juvenile stage
...
figure(6)
plot(t(1:i_2cm),L_w(1:i_2cm), 'Color', 'black') % time in days VS Length in cm
