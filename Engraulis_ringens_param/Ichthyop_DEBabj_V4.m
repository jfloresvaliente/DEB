...
subdir = strcat('C:/Users/jflores/Documents/JORGE/TESIS/TESIS_PHD/DEB/ichthyop_DEB/Engraulis_ringens_param/DEBoutV4/','Lw',num2str(talla));
mkdir(subdir);
...
%     end
    ...
    out_mat = table(t,E,V,E_H,E_R,F,acc,del,t_vec,f_vec,starva,...
                        'VariableNames',...
                        {'t','E','V','E_H','E_R','Fec','acc','delta','temp','f','starvation'});
